                    ...
                    <Tab.Pane eventKey='idea'>
                        <div className='about-content__idea'>
                            ...
                            <div className='about-content__text'>
                                ...
                                ПРИХОДИТСЯ
                                ДЕШИФРОВАТЬ, ЧТОБЫ ПОНЯТЬ СУТЬ. ШРИФТ ПОДДЕРЖИВАЕТ ВАРИАТИВНОСТЬ, ПОЭТОМУ НАЧЕРТАНИЯ
                                МОГУТ
                                ПЛАВНО МЕНЯТЬСЯ ОТ ОДНОГО К ДРУГОМУ.
                            </div>
                            <div className='about-content__text'>ЗА ОСНОВУ КЛАССИФИКАЦИИ МАТНЫХ СЛОВ Я ВЗЯЛА БОЛЬШОЙ
                                СЛОВАРЬ
                                МАТА ПЛУЦЕРА-САРНО, РАЗОБРАВШИСЬ
                                В ЭТИМОЛОГИИ НЕЦЕНЗУРНЫХ СЛОВ. ОНИ ДЕЛЯТСЯ НА ЧЕТЫРЕ БОЛЬШИЕ ГРУППЫ — ПРОИЗВОДНЫЕ ОТ
                                ЧЕТЫРЕХ
                                КОРНЕЙ: ХУЙ, ПИЗДА, ЕБАТЬ, БЛЯДЬ. КСТАТИ, ИМЕННО ЭТИ КАТЕГОРИИ СЛОВ ЗАПРЕЩАЕТ
                                РОСКОМНАДЗОР В
